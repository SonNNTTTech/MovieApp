...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<MovieType, HomeEntity> mapState});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({final Map<MovieType, HomeEntity> mapState = const {}})
      : _mapState = mapState;
  ...
  @override
  String toString() {
    return 'HomeState(mapState: $mapState)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_mapState));
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final Map<MovieType, HomeEntity> mapState}) =
      _$HomeStateImpl;

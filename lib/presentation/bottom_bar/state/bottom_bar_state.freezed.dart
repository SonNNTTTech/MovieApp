...
abstract class $BottomBarStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int indexTab, PersistentTabController controller});
}
...
class _$BottomBarStateImpl implements _BottomBarState {
  const _$BottomBarStateImpl(
      {required this.indexTab, required this.controller});
  ...
  @override
  String toString() {
    return 'BottomBarState(indexTab: $indexTab, controller: $controller)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, indexTab, controller);
